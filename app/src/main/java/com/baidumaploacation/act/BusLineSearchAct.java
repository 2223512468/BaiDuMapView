...
import com.baidumaploacation.routeplan.overlayutil.BusLineOverlay;
...
public class BusLineSearchAct extends FragmentActivity implements
    ...
    private TextView searchLine, nextLine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchLine = (TextView) findViewById(R.id.search);
        nextLine = (TextView) findViewById(R.id.nextline);
