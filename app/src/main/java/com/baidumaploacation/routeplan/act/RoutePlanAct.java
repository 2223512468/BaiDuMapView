 ...
 */
package com.baidumaploacation.routeplan.act;
...
import com.baidumaploacation.routeplan.adapter.RouteLineAdapter;
import com.baidumaploacation.routeplan.overlayutil.BikingRouteOverlay;
import com.baidumaploacation.routeplan.overlayutil.DrivingRouteOverlay;
import com.baidumaploacation.routeplan.overlayutil.MassTransitRouteOverlay;
import com.baidumaploacation.routeplan.overlayutil.OverlayManager;
import com.baidumaploacation.routeplan.overlayutil.TransitRouteOverlay;
import com.baidumaploacation.routeplan.overlayutil.WalkingRouteOverlay;
...
public class RoutePlanAct extends Activity implements BaiduMap.OnMapClickListener,
    ...
    private EditText cityEdit, startEdit, endEdit;
    private String cityName, startName, endName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.transit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                searchButtonProcess(view);
            }
    ...
    public void searchButtonProcess(View v) {
        ...
        startName = startEdit.getText().toString();
        endName = endEdit.getText().toString();

        startNodeStr = startName;
        endNodeStr = endName;
