...
import com.baidumaploacation.routeplan.overlayutil.PoiOverlay;
...
public class PoiSearchAct extends FragmentActivity implements
    ...
    private TextView searchCity, searchNear, searchArea;
    /**
     * 搜索关键字输入窗口
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        searchCity = (TextView) findViewById(R.id.search);
        searchNear = (TextView) findViewById(R.id.searchNearby);
        searchArea = (TextView) findViewById(R.id.searchBound);
